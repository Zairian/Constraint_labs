...
public class SplitSearch1 {
    ...
    public boolean label(IntVar[] vars) {
        ...
        if (!consistent) {
            ...
            store.impose(choice.getLessThanEqConstraint());
            ...
            if (consistent) {
                ...
                store.impose(choice.getGreaterThanConstraint());
    ...
    public class ChoicePoint {
        ...
        public PrimitiveConstraint getLessThanEqConstraint(){return new XlteqC(var, midValue); }

        public PrimitiveConstraint getGreaterThanConstraint() { return new XgtC(var, midValue); }
    }
}
