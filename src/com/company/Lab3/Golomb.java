...
public class Golomb {
    ...
    public void model() {
        ...
        SelectChoicePoint<IntVar> select = new InputOrderSelect<>( store, numbers , new IndomainMin<IntVar>());

        boolean result2 = label.labeling(store, select, cost);
        System.out.println("Total number of visited nodes = " + label.getNodes());
        System.out.println("Total number of failed nodes = " + label.getBacktracks());
